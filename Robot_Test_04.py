...
def StartDialog():
  ...
  textToSpeak = 'espeak -s95 "' + random.choice(helloList) + '" 2>/dev/null'
  ...
  textToSpeak = 'espeak -s95 "' + random.choice(questionList) + '" 2>/dev/null'
  ...
  textToSpeak = 'espeak -s95 "' + random.choice(leavingList) + '" 2>/dev/null'
...
def TurnRight():
  ...
  textToSpeak = 'espeak -s95 "' + random.choice(turnList) + '" 2>/dev/null'
...
stopList = ['Stop', 'What is this?', 'There is something ahead', 'I can see something', 'Nothing can stop me', 'Never, never,never stop me', 'I do not want to crash']

turnList = ['I want to turn', 'I have to avoide obstacles', 'I am very carefull', 'I do not want to have a problem']

helloList = ['Glad to see you', 'I want to be your friend', 'My name is robot Saaahaar. I am great', 'Hello. Hello again', 'Good morning. Or good night']

questionList = ['What is your name?', 'Do you want to be a robot?', 'Do you like robots?', 'Can you dance?', 'How are you?', 'How old are you?']

leavingList = ['Great', 'Fantastic', 'You are great', 'This is ok', 'You are just fine', 'Great, but I have to go', 'ok. Let me move']
